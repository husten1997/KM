...
public class Rekrutieren {
	...
	public static Soldat Bogenschuetze(int posx, int posy, int w, int he) {
	...
	public static Soldat Abgesessener_Ritter(int posx, int posy, int w, int he) {
	...
	public static Soldat Kolbentraeger(int posx, int posy, int w, int he) {
	...
	public static Soldat Armbrustschuetze(int posx, int posy, int w, int he) {
	...
	public static Soldat Speertraeger(int posx, int posy, int w, int he) {
	...
	public static Soldat Pikenier(int posx, int posy, int w, int he) {
	...
	public static Soldat Hoplit(int posx, int posy, int w, int he) {
	...
	public static Soldat Leichter_Reiter(int posx, int posy, int w, int he) {
	...
	public static Soldat Schwerer_Reiter(int posx, int posy, int w, int he) {
	...
	public static Soldat Leichter_Lanz_Reiter(int posx, int posy, int w, int he) {
	...
	public static Soldat Schwerer_Lanz_Reiter(int posx, int posy, int w, int he) {
	...
	public static Soldat Hussar(int posx, int posy, int w, int he) {
	...
	public static Soldat Leichter_Fernkampf_Reiter(int posx, int posy, int w, int he) {
	...
	public static Soldat Schwerer_Fernkampf_Reiter(int posx, int posy, int w, int he) {
	...
	public static Soldat Kanone(int posx, int posy, int w, int he) {
	...
	public static Soldat Leiter(int posx, int posy, int w, int he) {
	...
	public static Soldat Katapult(int posx, int posy, int w, int he) {
	...
	public static Soldat Rammbock(int posx, int posy, int w, int he) {
	...
	public static Soldat Schild(int posx, int posy, int w, int he) {
	...
	public static Soldat Baliste(int posx, int posy, int w, int he) {
	...
	public static Soldat Tribok(int posx, int posy, int w, int he) {
	...
	public static Soldat Kleines_Handelsschiff(int posx, int posy, int width, int height) {
	...
	public static Soldat Großes_Handelsschiff(int posx, int posy, int width, int height) {
	...
	public static Soldat Bewaffnetes_Handelsschiff(int posx, int posy, int width, int height) {
	...
	public static Soldat Kleines_Kriegsschiff(int posx, int posy, int width, int height) {
	...
	public static Soldat Großes_Kriegsschiff(int posx, int posy, int width, int height) {
	...
	public static Soldat Kutsche(int posx, int posy, int width, int height) {
	...
	public static Soldat Handelskarren(int posx, int posy, int width, int height) {
	...
	public static Soldat Transportkarren(int posx, int posy, int width, int height) {

...
public class Rekrutieren {
	...
	public Truppen Bogenschuetze(){
		Infanterie t = new Infanterie(40);
	...
	public Truppen Ritter(){
		Infanterie t = new Infanterie(80);
	...
	public Truppen Kolbentraeger(){
		Infanterie t = new Infanterie(50);
	...
	public Truppen Speertraeger(){
		Infanterie t = new Infanterie(45);
	...
	public Truppen Pikeniere(){
		Infanterie t = new Infanterie(75);
	...
	public Truppen Phalanx(){
		Infanterie t = new Infanterie(55);
	...
	public Truppen Leichte_Reiter(){
		Kavallerie t = new Kavallerie(45);
	...
	public Truppen Schwere_Reiter(){
		Kavallerie t = new Kavallerie(65);
	...
	public Truppen Leichte_Lanz_Reiter(){
		Kavallerie t = new Kavallerie(35);
	...
	public Truppen Hussaren(){
		Kavallerie t = new Kavallerie(66);
	...
	public Truppen Leichte_Fernkampf_Reiter(){
		Kavallerie t = new Kavallerie(25);
	...
	public Truppen Schwere_Fernkampf_Reiter(){
		Kavallerie t = new Kavallerie(40);
	...
	public Truppen Kanone(){
		Artillerie t = new Artillerie(50);
	...
	public Truppen Leiter(){
		Artillerie t = new Artillerie(10);
	...
	public Truppen Katapult(){
		Artillerie t = new Artillerie(20);
	...
	public Truppen Rammbock(){
		Artillerie t = new Artillerie(30);
	...
	public Truppen Schild(){
		Artillerie t = new Artillerie(80);
	...
	public Truppen Baliste(){
		Artillerie t = new Artillerie(75);
	...
	public Truppen Tribok(){
		Artillerie t = new Artillerie(70);

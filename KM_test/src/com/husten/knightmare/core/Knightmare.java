...
public class Knightmare extends Widget implements StringConstants {
	...
	protected void layout() {
		...
		geb‰ude[0][0].setPosition((int) baustart.getX() + 0 * 64, (int) baustart.getY());
		geb‰ude[0][1].setSize(64, 64);
		geb‰ude[0][1].setBackground(themeManager.getImage("eisenmine"));
		geb‰ude[0][1].setPosition((int) baustart.getX() + 1 * 64 + 1 * 10, (int) baustart.getY());
		geb‰ude[0][2].setSize(64, 64);
		geb‰ude[0][2].setBackground(themeManager.getImage("button.background"));
		geb‰ude[0][2].setPosition((int) baustart.getX() + 2 * 64 + 2 * 10, (int) baustart.getY());

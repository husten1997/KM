...
//					inGameStat = state.N_BUILDINGS;
	...
	protected void layout() {
		...
		geb‰ude[0][0].setBackground(themeManager.getImage("button.background"));
		geb‰ude[0][0].setPosition((int) baustart.getX(), (int) baustart.getY());
		geb‰ude[0][1].setSize(64, 64);
		geb‰ude[0][1].setBackground(themeManager.getImage("button.background"));
		geb‰ude[0][1].setPosition((int) baustart.getX() + 1 * 64, (int) baustart.getY());
		geb‰ude[0][2].setSize(64, 64);
		geb‰ude[0][2].setBackground(themeManager.getImage("button.background"));
		geb‰ude[0][2].setPosition((int) baustart.getX() + 2 * 64, (int) baustart.getY());
	...
	private void GUI() {
		geb‰ude[0][0] = new Button();
		geb‰ude[0][0].addCallback(new Runnable() {
		...
		geb‰ude[0][1] = new Button();
		geb‰ude[0][1].addCallback(new Runnable() {
		...
		geb‰ude[0][2] = new Button();
		geb‰ude[0][2].addCallback(new Runnable() {
